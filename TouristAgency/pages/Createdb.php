...
$ct7 = "create table comments( id int not null auto_increment primary key, date_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP, stars int, comment_text text not null, users_id int, foreign key(users_id) references users(id) on delete cascade, hotels_id int, foreign key(hotels_id) references hotels(id) on delete cascade) default charset='utf8';";
